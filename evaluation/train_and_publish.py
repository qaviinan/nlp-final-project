...
def main():
    ...
    parser.add_argument("--warmup_steps",        type=int,   default=100,                help="LR warmup steps — shorter for continuation")
    ...
    parser.add_argument("--checkpoint_name",     type=str,   default="multitask-8b-v5b", help="Base checkpoint name")
    ...
    # Load datasets — same mixture as v5
    print("\nLoading datasets...")
